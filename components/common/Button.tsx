...
const buttonVariants = cva(
  "inline-flex p-2 m-1 items-center justify-center transition-colors duration-150 pixel-round pixel-bevel whitespace-nowrap overflow-hidden text-ellipsis",
  {
    variants: {
      size:{
